    ...
    <>
      ...
      <div className="app">
        ...
        <div className="disclaimer">
          <strong>⚠ DISCLAIMER:</strong> This tool collects real data from the Twitch API — follower timestamps, live chatter counts, username entropy, VOD views, subscriptions, and moderator counts — and uses an AI model to interpret those signals. The <strong>chatSample table</strong> uses real chatter usernames but AI-estimated message counts and account ages (Twitch does not expose per-user chat history via public API). Risk scores reflect patterns in the real data, not definitive proof of botting. Do not use results to make accusations against creators.
        </div>
